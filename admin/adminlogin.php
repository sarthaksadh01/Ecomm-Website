...
body
{
    ...
    <div class="baslik">
        <b style="font-size: 101px; text-align: center; margin-bottom: -21px; display: block;">Nav Trading Company</b>
        
    </div>
    <section>
    <form method="post" action="adminlogin01.php" >
        <div class="arkalogin">
            <div class="loginbaslik">Admin Login</div>
            <hr style="border: 1px solid #ccc;">
            <input class="giris" type="password" name="admin" placeholder="•••••">
          <button class="butonlogin" type="submit" name="submit" >Submit</button>
        </div>
    </form>
    </section><br>
